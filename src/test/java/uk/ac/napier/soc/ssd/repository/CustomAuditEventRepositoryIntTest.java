package uk.ac.napier.soc.ssd.repository;

import uk.ac.napier.soc.ssd.VulWebApp;
import uk.ac.napier.soc.ssd.config.Constants;
import uk.ac.napier.soc.ssd.config.audit.AuditEventConverter;
import uk.ac.napier.soc.ssd.domain.PersistentAuditEvent;
...
import static uk.ac.napier.soc.ssd.repository.CustomAuditEventRepository.EVENT_DATA_COLUMN_MAX_LENGTH;
