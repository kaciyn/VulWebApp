...
import uk.ac.napier.soc.ssd.config.Constants;
import uk.ac.napier.soc.ssd.VulWebApp;
import uk.ac.napier.soc.ssd.domain.Authority;
import uk.ac.napier.soc.ssd.domain.PersistentToken;
import uk.ac.napier.soc.ssd.domain.User;
import uk.ac.napier.soc.ssd.repository.AuthorityRepository;
import uk.ac.napier.soc.ssd.repository.PersistentTokenRepository;
import uk.ac.napier.soc.ssd.repository.UserRepository;
import uk.ac.napier.soc.ssd.security.AuthoritiesConstants;
import uk.ac.napier.soc.ssd.service.MailService;
import uk.ac.napier.soc.ssd.service.dto.UserDTO;
import uk.ac.napier.soc.ssd.service.dto.PasswordChangeDTO;
import uk.ac.napier.soc.ssd.web.rest.errors.ExceptionTranslator;
import uk.ac.napier.soc.ssd.web.rest.vm.KeyAndPasswordVM;
import uk.ac.napier.soc.ssd.web.rest.vm.ManagedUserVM;
import uk.ac.napier.soc.ssd.service.UserService;
...
@SpringBootTest(classes = VulWebApp.class)
