...
import { VulWebAppAdminModule } from 'app/admin/admin.module';
import {
    BlogComponent,
    BlogDetailComponent,
    BlogUpdateComponent,
...
@NgModule({
    imports: [VulWebAppSharedModule, VulWebAppAdminModule, RouterModule.forChild(ENTITY_STATES)],
...
export class VulWebAppBlogModule {}
